...
- Giao diện web responsive với HTML5/CSS3/JavaScript
- Upload drag & drop
...
- **Image Preprocessing:** Resize (4x), denoise, deskew, contrast enhancement
- **Tesseract OCR:** Multi-config (psm3/4/6) với Vietnamese support
- **Text Correction:** Fix common OCR errors (I→1, O→0, spelling)

### 4. **Smart Field Extraction Engine**
- **Fuzzy Matching:** 72% threshold cho keyword matching
- **Multi-Separator:** Phát hiện :, |, ;, ., spaces
- **Validation:** Kiểm tra mã KH, SĐT, số tiền
- **Post-processing:** Clean & format dữ liệu

### 5. **MongoDB Database**
- Dynamic schema (không cố định fields)
- GridFS lưu file ảnh & Excel
- Indexing cho search nhanh
...
[![FuzzyWuzzy](https://img.shields.io/badge/FuzzyWuzzy-Fuzzy%20Matching-purple?style=for-the-badge)](https://github.com/seatgeek/fuzzywuzzy)
